...
public class InstitucionController : Controller
{
    ...
    {
        var institucionesEliminadas = _institucionRepo.ObtenerInstitucionesEliminadas(); // Filtrar las instituciones eliminadas
    ...
    public IActionResult Restaurar(int? id)
    {
        ...
        _institucionRepo.Actualizar(institucion); // Guardar los cambios
        _institucionRepo.Grabar();

        TempData["Exitosa"] = "Institución restaurada exitosamente";
        return RedirectToAction(nameof(Papelera)); // Redirigir a la Papelera
    }
